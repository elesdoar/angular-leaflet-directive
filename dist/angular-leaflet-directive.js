...
=======
>>>>>>> b2852766ea597fedaeeaaf1593a70f1d526a6799
...
<<<<<<< HEAD
  ...
  angular.module('leaflet-directive').directive('layercontrol', [
    ...
    'leafletData',
    'leafletHelpers',
    function ($log, leafletData, leafletHelpers) {
      return {
        restrict: 'E',
        scope: {},
        replace: true,
        ...
        template: '<div class="angular-leaflet-control-layers" ng-click="mainClick($event)" ng-dblclick="mainClick($event)">' + '<div ng-repeat="(type, lys) in layers" class="lf-{{type}}">' + '<div ng-repeat="(key, layer) in lys">' + '<div class="lf-row" ng-switch="type">' + '<label class="lf-icon-bl" ng-switch-when="baselayers" ng-click="changeBaseLayer(key, $event)">' + '<i class="lf-icon" ng-class="layer.icon"></i>' + '<input class="leaflet-control-layers-selector" type="radio" name="lf-radio" ' + 'ng-show="false" ng-checked="baselayer === key" ng-value="key" /> ' + '{{layer.name}}' + '</label>' + '<label class="lf-icon-ol" ng-switch-when="overlays">' + '<i ng-class="layer.icon"></i>' + '<input class="lf-control-layers-selector" type="checkbox" ng-show="false"  ng-model="layer.visible"/> ' + '{{layer.name}} ' + '<div class="lf-icons">' + '<i class="lf-icon lf-up" ng-class="icons.up"></i> ' + '<i class="lf-icon lf-down" ng-class="icons.down"></i> ' + '<i class="lf-icon lf-open" ng-class="icons.open"></i>' + '</div>' + '</label>' + '<div class="lf-opacity" ng-switch-when="overlays">' + '<input type="text" class="lf-opacity-control" name="lf-opacity-control" data-key={{key}} ' + 'ng-value="layer.layerOptions.opacity === undefined? 100:layer.layerOptions.opacity*100" />' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>',
        link: function (scope, element, attrs, controller) {
