/*!
*  angular-leaflet-directive 0.9.0 2015-10-14
...
angular.module("leaflet-directive").factory('leafletLegendHelpers', function ($http, $q, $log, leafletHelpers) {
	var requestQueue = {},
		isDefined = leafletHelpers.isDefined;
...
angular.module("leaflet-directive").directive('legend', function (leafletLogger, $http, $timeout, leafletHelpers, leafletLegendHelpers) {
        var $log = leafletLogger,
